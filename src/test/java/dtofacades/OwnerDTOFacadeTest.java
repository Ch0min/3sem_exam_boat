...
public class OwnerDTOFacadeTest {
    ...
    public static void tearDownClass() {
        System.out.println("EXECUTION OF ALL TESTS IN OWNERDTOFACADETEST DONE");
    }
    ...
    @Test
    void getAllOwnersDTO() throws API_Exception {
        System.out.println("Testing getAllOwnersDTO...");
    ...
    @Test
    void getOwnersByBoatDTOTest() throws API_Exception {
        System.out.println("Testing getOwnersByBoatDTO...");
        List<OwnerDTO> ownersDTO = facade.getOwnersByBoat(String.valueOf(bdto3));
        assertEquals(bdto3.getOwners(), ownersDTO);
    }
