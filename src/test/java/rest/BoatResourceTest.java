...
public class BoatResourceTest {
    ...
    public void testServerIsUp() {
        ...
        given().when().get("/boats/all").then().statusCode(200);
    }
    ...
    void getAllBoatsTest() {
        ...
        assertThat(boatDTOs, containsInAnyOrder(bdto1, bdto2, bdto3, bdto4, bdto5));
    }

    @Test
    void createBoatTest() {
        Boat newBoat = new Boat("Testbrand", "T1", "Testefar", "test.png", harbour1);

        BoatDTO newBdto = new BoatDTO(newBoat);
        String requestBody = GSON.toJson(newBdto);
        ...
        given()
                ...
                .assertThat()
                .statusCode(200)
                .body("boatName", equalTo(newBdto.getBoatName()));
    }

    @Test
    void updateBoatTest() {
        bdto5.setBoatName("NyTesteNavn");
    ...
    void deleteBoatTest() {
        given()
                ...
                .pathParam("boatID", bdto1.getBoatID())
                .delete("/boats/{boatID}")
                .then()
                .statusCode(200);
    }
